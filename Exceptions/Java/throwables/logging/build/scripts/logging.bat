...
set CLASSPATH=%APP_HOME%\lib\logging.jar

@rem Execute logging
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LOGGING_OPTS%  -classpath "%CLASSPATH%" logging.Logging %CMD_LINE_ARGS%
...
if  not "" == "%LOGGING_EXIT_CONSOLE%" exit 1
exit /b 1
