...
- [301 Moved Permanently](https://airbrake.io/blog/http-errors/301-moved-permanently): The resource has been **permanently** moved and request method conversion from `POST` to `GET` is **allowed**.
